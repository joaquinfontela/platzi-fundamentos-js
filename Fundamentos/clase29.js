...
function obtenerPersonaje(id) {
  ...
  return new Promise(function(resolve, reject) { //A la promesa le pasamos dos parametros, resolve y reject, siempre.
    ...
    .fail(() => reject(id)) // Si ocurre algun error, se ejecuta fail, que hace lo que se le indique adentro de los parentesis.
                            // En este caso, llamar a reject().
  })
}

obtenerPersonaje(1)
.then((personData) => { // El .then() se ejecuta cuando se ejecuta el resolve.
